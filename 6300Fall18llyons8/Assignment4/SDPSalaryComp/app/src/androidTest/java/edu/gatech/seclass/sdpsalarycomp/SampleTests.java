...
public class SampleTests {
    ...
    public void test_Required_Names() {
        onView(withId(R.id.baseSalary)).check(matches(isDisplayed()));
        onView(withId(R.id.currentCity)).check(matches(isDisplayed()));
        onView(withId(R.id.newCity)).check(matches(isDisplayed()));
        onView(withId(R.id.targetSalary)).check(matches(isDisplayed()));
    }
