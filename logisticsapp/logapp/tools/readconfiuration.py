 ...
 * @filesource
 '''
from appowner.models import Configuration


def readConfiguration():
	'''
	read current configuration and send the object. The calling function/module extracts the configurations it wants to read/work with

	'''
	reply=None
	try:
		reply=Configuration.objects.get()
	except:
		reply=None
